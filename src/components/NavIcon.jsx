...
const handleProfile =()=>{
  ...
  <div className="flex z-20 gap-4 sm:gap-6 lg:gap-10">
   ...
   <Image src="/images/notification.png" alt ="logo" width={28} height={28} className="" />
 <Image src="/images/user.png" onClick={handleProfile} alt ="logo" width={28} height={28} className="cursor-pointer" />
