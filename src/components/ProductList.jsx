...
const ProductLists = ()=>{
  ...
  <button className="rounded-2xl ring-1 ring-lama text-lame py-2 px-4 hover:bg-lama hover:text-white">Add-to-cart</button>
     ...
     <Link href="/list" className="w-full flex flex-col gap-4 sm:w-[45%] lg:w-[22%]">
  <div className="relative h-96 w-full">
    <Image src={product_4} alt="product" fill size="25vw" className="absolute object-cover rounded-sm hover:opacity-0 transition-opacity  easy duration-500" />
  </div>
  <div className="flex justify-between">
  <span className="font-medum">Product Name</span>
    <span className="font-semibold">Price: $**</span>
  ...
  <button className="rounded-2xl ring-1 ring-lama text-lame py-2 px-4 hover:bg-lama hover:text-white">Add-to-cart</button>
       ...
       <Link href="/list" className="w-full flex flex-col gap-4 sm:w-[45%] lg:w-[22%]">
  <div className="relative h-96 w-full">
    <Image src={product_5 } alt="product" fill size="25vw" className="absolute object-cover rounded-sm hover:opacity-0 transition-opacity  easy duration-500" />
  </div>
  <div className="flex justify-between">
  <span className="font-medum">Product Name</span>
    <span className="font-semibold">Price: $**</span>
  ...
  <button className="rounded-2xl ring-1 ring-lama text-lame py-2 px-4 hover:bg-lama hover:text-white">Add-to-cart</button>
       ...
       <Link href="/list" className="w-full flex flex-col gap-4 sm:w-[45%] lg:w-[22%]">
  <div className="relative h-96 w-full">
    <Image src={product_6} alt="product" fill size="25vw" className="absolute object-cover rounded-sm hover:opacity-0 transition-opacity  easy duration-500" />
  </div>
  <div className="flex justify-between">
  <span className="font-medum">Product Name</span>
    <span className="font-semibold">Price: $**</span>
